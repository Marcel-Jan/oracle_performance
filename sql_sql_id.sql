...
--
--      Script      sql_sql_id.sql
--      Run as      DBA
--
--      Purpose     This script will retrieve a lot of info about a query, based on sql_id
--
...
--      ------- ----------- -------------- ----------------------------------------------------------------------------------------------
--      1.0     18 jan 2012 M. Krijgsman   Initieel
--      1.1     10 feb 2012 M. Krijgsman   Bug sql_id variabele verholpen.
--      1.2     25 jul 2012 M. Krijgsman   v$sql_bind_capture gegevens toegevoegd.
--      1.4     31 jul 2012 M. Krijgsman   Bind mismatch info toegevoegd. (nummering opgehoogd om in lijn te blijven met andere scripts)
--      1.5     19 okt 2012 M. Krijgsman   Bind variable commando's voor SQL*Plus van sample binds.
--      1.6     13 nov 2012 M. Krijgsman   English version, hash value info, sql plan baseline info included.
--      1.6.1   23 nov 2012 M. Krijgsman   Indication in "Different versions of the query" what is on this node
--      1.7     11 dec 2012 M. Krijgsman   All execution plans in sql plan baselines.
--      1.8     03 jan 2013 M. Krijgsman   Provide query response time history from diagnostics pack. Bug with instance indication solved.
--                                         Generated statements to purge the SQL from the shared pool and drop sql plan baselines.
------------------------------------------------------------------------------------------------------------------------------------------------------
...
spool &l_dbname._&sql_id._&datetime..txt
