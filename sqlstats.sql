...
--
--      Script      sqlstats.sql (formerly known as stats_sql_id_html.sql)
--      Run as      DBA
--
...
--      1.2     Jan 09 2014 M. Krijgsman   When searching for stats history, execution plans in AWR are now also taken into account.
------------------------------------------------------------------------------------------------------------------------------------------------------
